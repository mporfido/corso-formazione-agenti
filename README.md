# Dalla IA generativa alla IA agentica
...
| 3 | Il primo workflow controllato |
| 4 | Context engineering e memoria permanente |
...
distribuiti ai corsisti, che non sono opera nostra.

## Le slide

Ogni deck è un file HTML autonomo: si apre con un doppio clic nel browser, senza
installare nulla e senza connessione. Per ottenere il PDF si stampa la pagina
(`Ctrl+P`) scegliendo *Salva come PDF*; il layout è già predisposto per la stampa.
I PDF generati non sono versionati.

## La cartella di prova

`cartella-di-prova/` è una **3ª B di Matematica** a fine gennaio 2026: 21 studenti,
tre verifiche scritte, due giri di interrogazioni, qualche valutazione mancante
perché è la situazione reale in cui ci si trova.

> ⚠️ **Nomi, voti, date e annotazioni sono completamente inventati.** Durante le
> esercitazioni non inserite lì dati veri dei vostri studenti.

La cartella contiene il file-guida `AGENTS.md`, la convenzione canonica del corso;
`CLAUDE.md` e `GEMINI.md` sono solo rimandi a quello.
...
I materiali del corso sono distribuiti con licenza
[Creative Commons Attribuzione - Condividi allo stesso modo 4.0 Internazionale](https://creativecommons.org/licenses/by-sa/4.0/deed.it)
(CC BY-SA 4.0). Potete riusarli, adattarli e ridistribuirli, anche per fini
commerciali, a patto di citare la fonte e di rilasciare le opere derivate con la
stessa licenza. Il testo completo è in [LICENSE](LICENSE).
